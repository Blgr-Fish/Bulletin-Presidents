...
int main(void)
{
    ...
    {
        std::cout << "  Candidat n." << candidat->getId() << " : " << candidat->getNom()
                  << " " << candidat->getPrenom() << " " << candidat->getSensiPolitique() << std::endl;
    }
    ...
    for (auto candidat : bureauDeVote.getElection().getListeCandidats())
    {
        std::cout << " " << candidat->getNom() << " " << candidat->getPrenom() << " : "
                  << bureauDeVote.getListeElectorale().getTailleListeElectorale() << " bulletins" << std::endl;
    }
    ...
    while (!bureauDeVote.getFileBureauTableDecharge().empty() || !bureauDeVote.getFileTableDechargeIsoloires().empty() || !bureauDeVote.getFileIsoloiresTableVote().empty() || !bureauDeVote.getTableVote().estVide() || !bureauDeVote.getTableDecharge().estVide() || temps <= (int)Parametrage::TEMPS_MAX)
    {
